...
// ─── 八ヶ岳周辺 遺跡データ ────────────────────────────────────────────────
// 出典: 文化庁 国指定文化財等データベース / 各市町村教育委員会 遺跡台帳 / Wikidata
// 座標: Wikidata・国土地理院地図で照合済み WGS84

const RUINS_DATA = [

  // ─── 縄文時代 ───────────────────────────────────────────────
  {
    id: 'R001', name: '尖石遺跡', lat: 36.0128, lng: 138.2321,
  ...
  {
    id: 'R002', name: '与助尾根遺跡', lat: 36.0133, lng: 138.2330,
    period: 'jomon', periodLabel: '縄文中期', type: '集落跡',
    city: '茅野市', pref: '長野県',
  ...
  {
    id: 'R003', name: '棚畑遺跡', lat: 35.9706, lng: 138.2288,
    period: 'jomon', periodLabel: '縄文中期', type: '集落跡',
    city: '茅野市', pref: '長野県',
  ...
  {
    id: 'R004', name: '金生遺跡', lat: 35.8455, lng: 138.4918,
  ...
  {
    id: 'R005', name: '曽利遺跡', lat: 35.9117, lng: 138.2217,
    period: 'jomon', periodLabel: '縄文中期', type: '集落跡',
    city: '富士見町', pref: '長野県',
  ...
  {
    id: 'R006', name: '井戸尻遺跡', lat: 35.9092, lng: 138.2196,
  ...
  {
    id: 'R007', name: '藤内遺跡', lat: 36.0028, lng: 138.2348,
    period: 'jomon', periodLabel: '縄文中期', type: '集落跡',
    city: '茅野市', pref: '長野県',
  ...
  {
    id: 'R008', name: '上ノ段遺跡', lat: 36.0062, lng: 138.2388,
  ...
  {
    id: 'R009', name: '滝沢遺跡', lat: 35.9578, lng: 138.2905,
    period: 'jomon', periodLabel: '縄文中期', type: '集落跡',
    city: '原村', pref: '長野県',
  ...
  {
    id: 'R010', name: '阿久遺跡', lat: 35.8793, lng: 138.2075,
  ...
  {
    id: 'R011', name: '長坂上条遺跡', lat: 35.8403, lng: 138.4682,
  ...
  {
    id: 'R012', name: '大深山遺跡', lat: 35.9278, lng: 138.3972,
    period: 'jomon', periodLabel: '縄文中期', type: '集落跡',
    city: '南牧村', pref: '長野県',
  ...
  // ─── 黒曜石産地遺跡 ──────────────────────────────────────────
  {
    id: 'O001', name: '和田峠黒曜石産地遺跡', lat: 36.0893, lng: 138.2095,
  ...
  {
    id: 'O002', name: '星ヶ台黒曜石採掘遺跡', lat: 36.0821, lng: 138.2018,
    period: 'obsidian', periodLabel: '旧石器〜縄文', type: '石材採掘遺跡',
    city: '長和町', pref: '長野県',
  ...
  {
    id: 'O003', name: '男女倉遺跡（黒曜石採掘）', lat: 36.0703, lng: 138.2105,
    period: 'obsidian', periodLabel: '旧石器〜縄文', type: '石材採掘遺跡',
    city: '長和町', pref: '長野県',
  ...
  // ─── 弥生〜古墳時代 ──────────────────────────────────────────
  {
    id: 'K001', name: '大泉清里古墳群', lat: 35.9115, lng: 138.4432,
  ...
  {
    id: 'K002', name: '茅野市北山古墳群', lat: 36.0213, lng: 138.1658,
    period: 'kofun', periodLabel: '古墳時代', type: '古墳群',
    city: '茅野市', pref: '長野県',
  ...
  // ─── 中世〜近世 ──────────────────────────────────────────────
  {
    id: 'M001', name: '海ノ口城跡', lat: 35.8873, lng: 138.4388,
  ...
  {
    id: 'M002', name: '若神子城跡', lat: 35.8352, lng: 138.4972,
    period: 'medieval', periodLabel: '中世（戦国期）', type: '山城跡',
    city: '北杜市', pref: '山梨県',
  ...
  // ─── 古道・峠 ────────────────────────────────────────────────
  {
    id: 'T001', name: '棒道（武田の棒道）', lat: 35.9712, lng: 138.2418,
  ...
  {
    id: 'T002', name: '縄文海道（黒曜石交易路推定路）', lat: 35.9750, lng: 138.3650,
